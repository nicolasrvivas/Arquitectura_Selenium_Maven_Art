...
public class CP02130_Matriz_de_Información_Tabla_QA2_test extends TestBase {
	...
	public CP02130_Matriz_de_Información_Tabla_QA2_test(){
	   	super();
	}
	  
   	@BeforeMethod
	public void setUp_Matriz_de_Información_Tabla(){
	...
	@Test(priority=1)
	public String matrizTest(){
			
	//  Variables globales del caso
		String v_caso 					= "Caso_3";
		String v_caso_nombre 			= "CP02130_Matriz_de_Información_Tabla_QA2_test";
	...
	/*  -------------------------------------------------------------------------------------  */	
		if (v_valid_proceso=="EXITO"){
			v_valid_proceso = OP02130_MatrizInformacionTabla_Page.Ejec_MatrizInformacionTabla(v_name_imagen,
																								cont,
																								arr_datos,
																								arr_Elementos,
																								arr_Evidencia);
			arr_datos 		= OP02130_MatrizInformacionTabla_Page.Retorna_arr_datos();
			arr_Elementos 	= OP02130_MatrizInformacionTabla_Page.Retorna_arr_elementos();
			arr_Evidencia 	= OP02130_MatrizInformacionTabla_Page.Retorna_arr_evidencia();
			cont 			= OP02130_MatrizInformacionTabla_Page.Retorna_cont();
		}
	/*  -------------------------------------------------------------------------------------  */
