...
import Pages.Proy_2_QAnova_Piloto.OP02100_Data_Entrada_BD;
...
public class CP02121_Carga_Informacion_Data_QA2_test extends TestBase {
	...
	OP02100_Data_Entrada_BD					OP02100_Data_Entrada_BD_Page;
	
	
	public CP02121_Carga_Informacion_Data_QA2_test(){
	   	super();
	}
	  
   	@BeforeMethod
	public void setup_CP02121_Carga_Informacion_Data_QA2_test(){
		...
		OP02100_Data_Entrada_BD_Page					= new OP02100_Data_Entrada_BD();
	...
	//  Variables globales del caso
		String v_caso 					= "Caso_5";
		String v_caso_nombre 			= "CP02121_Carga_Informacion_Data_BD_QA2_test";
	...
	/*  -------------------------------------------------------------------------------------  */	
		arr_data = OP02100_Data_Entrada_BD_Page.Ejec_PaginaInicioQA2(v_caso);
		v_valid_proceso 			= OP02100_Data_Entrada_BD_Page.Retorna_valid_proceso();
		if (v_valid_proceso=="EXITO"){
			d_Usuario 				= arr_data.get(2);
	        d_Pass 					= arr_data.get(3);
	        d_campo_text 			= arr_data.get(4);
	        d_Campo_Area_de_Texto 	= arr_data.get(5);
	        d_campo_mail 			= arr_data.get(6);
	        d_campo_fecha 			= arr_data.get(7);
	        d_campo_lista 			= arr_data.get(8);
	        d_seleccion 			= arr_data.get(9);
	        d_radio_button 			= arr_data.get(10);
		}
	/*  -------------------------------------------------------------------------------------  */
	...
	/*  =====================================================================================  */
		...
		/*  -------------------------------------------------------------------------------------  */
			...
			v_valid_proceso = OP02100_Data_Entrada_Excel_Page.busca_nro_fila_resultados(v_caso,
...
//		UPdateExcelFile_Page.writeExcel(filePath,fileName,sheetName,v_dataToWrite_1,v_fila_grab,v_celda_grab_1,v_hoja);
//		esperarSegundos(driver, 1);
//		UPdateExcelFile_Page.writeExcel(filePath,fileName,sheetName,v_dataToWrite_2,v_fila_grab,v_celda_grab_2,v_hoja);
//		esperarSegundos(driver, 1);
//		UPdateExcelFile_Page.writeExcel(filePath,fileName,sheetName,v_dataToWrite_3,v_fila_grab,v_celda_grab_3,v_hoja);
//		esperarSegundos(driver, 1);
//		UPdateExcelFile_Page.writeExcel(filePath,fileName,sheetName,v_dataToWrite_4,v_fila_grab,v_celda_grab_4,v_hoja);
//		esperarSegundos(driver, 1);
//		UPdateExcelFile_Page.writeExcel(filePath,fileName,sheetName,v_dataToWrite_5,v_fila_grab,v_celda_grab_5,v_hoja);
