...
import Pages.Cardif.OP02110_PaginaInicioCardif;
...
public class CP02150_BNP_Paribas_Cardif_test extends TestBase {
	...
	OP02110_PaginaInicioCardif				OP02110_PaginaInicioCardif_Page;

	public CP02150_BNP_Paribas_Cardif_test(){
	   	super();
	}
	  
   	@BeforeMethod
	public void setUp_BNP_Paribas_Cardif_test(){
		...
		OP02110_PaginaInicioCardif_Page					= new OP02110_PaginaInicioCardif();
...
//	}
	...
	/*  -------------------------------------------------------------------------------------  */	
		if (v_valid_proceso=="EXITO"){
			cont=1;
			v_valid_proceso = OP02110_PaginaInicioCardif_Page.Ejec_PaginaInicioCardif(v_name_imagen,
																				cont,
																				arr_datos,
																				arr_Elementos,
																				arr_Evidencia);
			arr_datos 		= OP02110_PaginaInicioCardif_Page.Retorna_arr_datos();
			arr_Elementos 	= OP02110_PaginaInicioCardif_Page.Retorna_arr_elementos();
			arr_Evidencia 	= OP02110_PaginaInicioCardif_Page.Retorna_arr_evidencia();
			cont 			= OP02110_PaginaInicioCardif_Page.Retorna_cont();
		}
	/*  -------------------------------------------------------------------------------------  */
	/*  ------------                    Fin Paso Login                           ------------  */
	/*  =====================================================================================  */
