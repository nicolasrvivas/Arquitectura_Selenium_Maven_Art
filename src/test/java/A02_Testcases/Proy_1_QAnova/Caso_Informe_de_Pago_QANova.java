...
public class Caso_Informe_de_Pago_QANova extends TestBase {
	...
	public Caso_Informe_de_Pago_QANova(){
	   	super();
	}
...
//	}
	...
	/*  ------------------------------------------------------------------  */
		...
		String title34 = comprapasaje3Page.cambiopagina();
		System.out.println("<<---------------------------->>");
	...
	/*  ------------------------------------------------------------------  */
		...
		arr_Elementos = informepagoPage.ValidaelementosInformePago(arr_Elementos);
		System.out.println("<<---------------------------->>");
		System.out.println("     Test InformePagoPage");
		System.out.println("<<---------------------------->>");
		String datotabla3 = informepagoPage.ExtraerDatoTabla3();
		System.out.println("<<---------------------------->>");
		System.out.println(datotabla3); 
		System.out.println("<<---------------------------->>");
		String title5 = informepagoPage.ValidacionInformePago();
		Assert.assertEquals(title5, "Informe de Pago - Practica QA Nova");
		
		if(title5.equals("Informe de Pago - Practica QA Nova")) {
			arr_Evidencia.add("Informe de Pago;");
			arr_Evidencia.add("Finalizó Correctamente Informe de Pago;");
			arr_Evidencia.add("Passed;");
		}else {
			arr_Evidencia.add("Compra Pasajes;");
			arr_Evidencia.add("No finalizó Correctamente Informe de Pago;");
			arr_Evidencia.add("Failed;");
		}
