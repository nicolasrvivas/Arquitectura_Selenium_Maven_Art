...
public class EditarInformePago2 extends TestBase {
...
//		System.out.println("------->>   pageSource  <<--------");
		...
		File archivo=new File("d:\\Escribir_texto.txt");

		//Crear objeto FileWriter que sera el que nos ayude a escribir sobre archivo
		FileWriter escribir=new FileWriter(archivo,true);

		//Escribimos en el archivo con el metodo write 
		escribir.write(pageSource);
		...
		WebElement source12 = driver.findElement(By.xpath("//*[@id='pluginAppObj_5_02_jtable']/following-sibling::span[2]/select"));
		//WebElement source12 = driver.findElement(By.xpath("//*[@id=\'pluginAppObj_5_02_jtable\' and contains(text(), 'select')]"));
		//div[@class='bubble-title' and contains(text(), 'Cover')]
		Select list12 = new Select(source12);
		List<WebElement> elements12 = list12.getOptions();		
		int v_elementos12 = elements12.size();
		System.out.println("  -----    v_elementos12  --->>  "+v_elementos12);
